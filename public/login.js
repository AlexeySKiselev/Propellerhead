...
var Button = function (_Component) {
    ...
    function Button(props) {
        ...
        var additionalClass = _this.props.additionalClass || '';
        _this._className = 'button ' + additionalClass;
        return _this;
    }
    ...
    _createClass(Button, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: this._className, onClick: this.props.clickHandler },
                this.props.label
            );
        }
    }]);
...
var LoginMain = function (_Component) {
    ...
    function LoginMain(props) {
        ...
        var _this = _possibleConstructorReturn(this, (LoginMain.__proto__ || Object.getPrototypeOf(LoginMain)).call(this, props));
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'login_error ' + this.state.errorvisible },
                        this.state.errormsg
                    ),
                    _react2.default.createElement(
                        'form',
                        { id: 'login_form', className: 'login_form' },
                        _react2.default.createElement(
                            'label',
                            { htmlFor: 'signin_email' },
                            'E-mail:'
                        ),
                        _react2.default.createElement('input', { type: 'text', name: 'signin_email', placeholder: 'Enter e-mail', onChange: this.handleInput.bind(this) }),
                        _react2.default.createElement(
                            'label',
                            { htmlFor: 'signin_password' },
                            'Password:'
                        ),
                        _react2.default.createElement('input', { type: 'password', name: 'signin_password', placeholder: 'Enter password', onChange: this.handleInput.bind(this) })
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'login_button' },
                        _react2.default.createElement(_Button2.default, { label: 'Login', additionalClass: 'login_button_float', clickHandler: this.submitLogin.bind(this) })
                    )
                )
            );
        }
...
_reactDom2.default.render(_react2.default.createElement(LoginMain, null), document.getElementById('login_app'));

},{"./Button":1,"axios":3,"react":"react","react-dom":"react-dom"}],3:[function(require,module,exports){
